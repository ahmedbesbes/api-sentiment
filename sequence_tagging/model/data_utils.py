...
def export_trimmed_fasttext_vectors(vocab, trimmed_filename, dim):
#def export_trimmed_fasttext_vectors(vocab, fasttext_filename, trimmed_filename, dim):
    ...
    for w in vocab:
        ...
        embeddings.append(np.array(wiki_model[w.lower()]))
   ...
   #             embeddings[word_idx] = np.asarray(embedding)
    ...
    # wiki_model = fasttext.load_model("model.bin", encoding='utf-8')
